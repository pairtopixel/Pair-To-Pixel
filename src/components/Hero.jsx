...
import heroVideo from '../assets/heroBG_video.mp4'; // Import the video file
// Then, use it in the source tag:
const Hero = () => {
  return (
...
<source src={heroVideo} type="video/mp4" />
      ...
      {/* Hero Content */}
      <div className="relative z-10 flex items-center justify-start h-full px-6 md:px-24 lg:px-48">
        <div className="w-full max-w-lg space-y-8">
          <div className="space-y-2">
            <h1 className="text-3xl md:text-4xl lg:text-6xl font-bold tracking-tight leading-tight">
              HI,<br />WE'RE PAIR TO PIXEL!
            </h1>
            <p className="text-xl md:text-2xl font-light italic text-orange-400">
          ...
          <div className="flex space-x-4">
            <a href="https://www.facebook.com/pairtopixel"> 
            <button className="px-6 py-3 text-md font-bold text-white bg-red-600 rounded-md hover:bg-red-700 transition-colors duration-200">
              Start Your Project
            </button></a>
            <a href="https://www.facebook.com/pairtopixel">
            <button className="px-6 py-3 text-md font-bold text-white bg-gray-600 rounded-md hover:bg-gray-700 transition-colors duration-200">
              Get 50% Off
            </button></a>
          </div>
        </div>
